...
export default function ProductsClient() {
  ...
  const categoryKeys: { [key: string]: string } = {
    'All Products': 'products.catAll',
    'Rice & Paddy': 'products.catRice',
    'Wheat': 'products.catWheat',
    'Maize': 'products.catMaize',
    'Pulses': 'products.catPulses',
    'Oilseeds': 'products.catOilseeds',
    'Spices': 'products.catSpices'
  };
    ...
    <div className="relative bg-gradient-to-b from-green-50/40 via-white to-white min-h-screen py-12 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h1 className="text-4xl font-extrabold text-slate-800 mb-4">{t("products.title")}</h1>
        ...
        <div className="mt-20 relative bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-green-100/60 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-xl font-bold text-slate-800 mb-2">
              {t("products.ctaTitle") || "Can't find what you're looking for?"}
            </h3>
            <p className="text-slate-500 mb-6">
              {t("products.ctaDesc") || "Our marketplace is updated daily with new listings from farmers across India."}
            </p>
